  ...
  return (
    <div className="mb-10 group/row relative">
      ...
      <div className="relative">
        ...
        {/* Fade edges */}
        {canScrollLeft && (
          <div className="absolute left-0 top-0 bottom-0 w-12 pointer-events-none bg-gradient-to-r from-background to-transparent z-[5]" />
        )}
        {canScrollRight && (
          <div className="absolute right-0 top-0 bottom-0 w-12 pointer-events-none bg-gradient-to-l from-background to-transparent z-[5]" />
        )}
      </div>
    </div>
  );
